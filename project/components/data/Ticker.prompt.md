...
It is a block in normal flow, never `position: fixed`. Put it last in the page column, after the content. A fixed strip sits over the bottom row of whatever is on screen, and in One Link that row is usually a wide table somebody is reading.
